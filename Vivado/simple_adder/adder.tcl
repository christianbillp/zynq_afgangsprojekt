...
if { $bCheckIPs == 1 } {
   set list_check_ips "\ 
ChristianBillPedersen:CBP_lib:add:1.0\
...
proc create_root_design { parentCell } {
  ...
  set add_0 [ create_bd_cell -type ip -vlnv ChristianBillPedersen:CBP_lib:add:1.0 add_0 ]
  ...
  connect_bd_net -net rst_ps8_0_100M_peripheral_aresetn [get_bd_pins add_0/ap_rst_n] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps8_0_100M/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0xA0000000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs add_0/s_axi_AXILiteS/Reg] SEG_add_0_Reg
