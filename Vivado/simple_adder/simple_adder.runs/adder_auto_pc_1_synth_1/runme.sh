...
HD_PWD='C:/Users/chris/Projects/zynq_afgangsprojekt/Vivado/simple_adder/simple_adder.runs/adder_auto_pc_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log adder_auto_pc_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source adder_auto_pc_1.tcl
